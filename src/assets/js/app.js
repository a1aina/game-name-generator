...
const influenceMap = {
  tank: "hard", dps: "hard", strong: "hard", robust: "hard", brutal: "hard", fire: "hard", metal: "hard", blood: "hard", evil: "hard",
  healer: "soft", support: "soft", buffer: "soft", elegant: "soft", wise: "soft", good: "soft", light: "soft", water: "soft", air: "soft", spirit: "soft", redeemed: "soft",
  rogue: "shadow", debuffer: "shadow", mysterious: "shadow", dark: "shadow", shadow: "shadow", poison: "shadow", corrupted: "shadow", unknown: "shadow",
  mage: "arcane", summoner: "arcane", psychic: "arcane", arcane: "arcane", time: "arcane",
  ranger: "nature", nature: "nature", earth: "nature", noble: "ancient", ancient: "ancient", lawful: "ancient",
  quick: "swift", small: "swift", chaotic: "swift", electric: "swift", mercenary: "hard"
};
...
function buildPools(profile, config, mode) {
  ...
  return { starts, middles, ends, families, inspired };
}
...
function generateFantasy(config, mode = "generated", reference = null) {
  ...
  for (let attempt = 0; attempt < 45; attempt += 1) {
    ...
    candidates.push({
      name: cleaned,
      score,
      meta: { pattern, start, middle, end, anchor, profile: profile.label, families: pools.families, inspired: pools.inspired }
    });
  }
